...
public:
	...
	virtual bool GetAllLineItems(std::vector<cISC4LineItem*>& destination) = 0;
	...
	virtual bool GetLocallyFundedItemsByPurpose(uint32_t unknown1, std::list<cRZAutoRefCount<cISCPropertyHolder>>& unknown2) = 0;
